...
- `refusal_direction_full.mp4` — the assembled video (~2m15s, 1080p60), produced by
  rendering all scenes and concatenating them
...
`media/` (manim's render cache) is not checked in.
